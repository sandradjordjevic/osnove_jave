...
//        U glavnom programu kreirati objekte definisanih klasa i testirati rad definisanih funkcija
        ...
        Korisnik korisnik1 = new Korisnik("Mika Mikic");
        Korisnik korisnik2 = new Korisnik("Pera Peric");
        korisnik1.stampaj();
        korisnik2.stampaj();
        ZoomCall poziv1 = new ZoomCall("https://us02web.zoom.us/postattendee?mn=rq", "567804", korisnik1);
        poziv1.setGuest(korisnik2);
        poziv1.pokreniPoziv();
